...
inat_csv = r"W:\Heritage\Heritage_Data\CommSciVet\iNatDataTest_third.csv"
inat_fields = ["id", "observed_on", "user_id", "user_login", "created_at", "updated_at", "license", "url", "image_url",
               "sound_url", "tag_list", "description", "captive_cultivated", "place_guess", "latitude", "longitude",
               ...
               "positioning_method", "positioning_device", "place_county_name", "scientific_name", "common_name",
               "iconic_taxon_name", "taxon_id", "taxon_order_name", "taxon_family_name", "field_count", "SHAPE@"]
...
temp_inat_import = arcpy.Project_management(temp_inat_import,
                                            os.path.join(os.path.dirname(comm_fc), "temp_inat_import_albers"), sref)
